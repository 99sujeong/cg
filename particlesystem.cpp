...
// file is defining something that your hardware doesn뭪 actually support. 
// Try recompiling the sample using your own local, vendor-specific "glext.h" 
// header file.

#include "glext.h"   // glext.h 기본 항목에 추가
// gl.h에 들어가지 못하는데 graphics card 회사에서 추가로 기능을 더 확장했을때는 glext.h 에 담아서 배포
// 다운로드 : https://ko.osdn.net/projects/sfnet_apiary-db/downloads/Windows/common/GL/glext.h/
